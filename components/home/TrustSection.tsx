        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-zinc-100">
              <Image
                src="https://images.unsplash.com/photo-1562016600-ece13e8ba570?w=800&q=80"
                alt="Fachada DGR Veículos"
                fill
          ...
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-zinc-900 mb-6 leading-tight">
              Transparência e qualidade em cada negócio
            </h2>
            <p className="text-zinc-500 leading-relaxed mb-8">
              Na DGR Veículos, cada seminovo passa por uma rigorosa inspeção técnica antes
              de entrar no nosso estoque. Você compra com a segurança de quem conhece o
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {seals.map((seal, i) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-zinc-700">{seal}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
